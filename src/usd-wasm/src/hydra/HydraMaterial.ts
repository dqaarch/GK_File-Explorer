...
class HydraMaterial {
  ...
  static vector2MaterialProperties = new Set([
    'normalScale',
    'clearcoatNormalScale',
  ]);

  static clamp01MaterialProperties = new Set([
    'clearcoat',
    'clearcoatRoughness',
    'metalness',
    'roughness',
  ...
  constructor(id, hydraInterface) {
    ...
    if (!getDefaultMaterial()) {
      setDefaultMaterial(new MeshPhysicalMaterial({
        side: DoubleSide,
